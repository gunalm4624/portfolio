...
export function AnimatedFolder({ title, projects, className, href }: AnimatedFolderProps) {
    ...
    const handleMouseEnter = () => {
        ...
        // Create and play audio instance for instant feedback
        const audio = new Audio("/assets/Sounds/Folder.mp3")
        audio.volume = 0.5
        audio.play().catch(() => {
            // Audio playback might be blocked if no user interaction occurred yet
            // or if the file path is incorrect.
        })

        // Haptic feedback (only works on supported devices like Android)
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative flex items-center justify-center mb-4 scale-150" style={{ height: "160px", width: "200px" }}>
                    {/* Folder back layer - z-index 10 */}
                    <div
                        className="absolute w-32 h-24 bg-sky-300 dark:bg-sky-900/50 rounded-lg shadow-md"
                        style={{
                    ...
                    <div
                        className="absolute w-12 h-4 bg-sky-400 dark:bg-sky-800/50 rounded-t-md"
                        style={{
                    ...
                    <div
                        className="absolute w-32 h-24 bg-sky-400 dark:bg-sky-800 rounded-lg shadow-lg"
                        style={{
                ...
                {/* Hover hint */}
                <div
                    className="absolute bottom-4 left-1/2 flex items-center gap-1.5 text-xs text-muted-foreground transition-all duration-300"
                    style={{
                    ...
                    <div className="relative overflow-hidden">
                        ...
                        >
                            {projects.map((project) => (
                                <div key={project.id} className="relative w-full h-auto max-h-[70vh] flex-shrink-0" style={{ minWidth: "100%" }}>
                                    <Image
