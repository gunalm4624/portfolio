...
export default function CtaButton({
  ...
  const sharedClassName = `relative flex h-12 w-full justify-center sm:w-auto items-center gap-2 overflow-hidden rounded-full bg-zinc-950 px-6 text-base font-normal text-white transition-all duration-300 hover:bg-[#ed254e] cursor-pointer dark:bg-white dark:text-zinc-950 dark:hover:bg-[#ed254e] dark:hover:text-white ${
    shadow
